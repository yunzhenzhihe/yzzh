...
(function() {
  ...
  var lbxMaxWidth = 600;     //弹出层最大宽度，2012.3.13 新加
  var lbxMaxHeight = 500;   //弹出层最大高度   2012.3.13 新加
  ...
  LightboxOptions = (function() {
    ...
    function LightboxOptions() {
     ...
     // this.fileCloseImage = '../images/close.png';
	  this.fileLoadingImage = loadingImage;   //2012.08.09 修改
      this.fileCloseImage = closeImage;	    //2012.08.09 修改
  ...
  Lightbox = (function() {
    ...
    Lightbox.prototype.changeImage = function(imageNumber) {
      ...
      // preloader.onload = function() {   2013.3.13 去掉
      ...
      // };
        ...
        preloader.onload = function () {    //2013.3.13 新加 解决图片太大显示不好的问题        
			   $image.attr('src', _this.album[imageNumber].link);

    ...
    var rowCount=1000;  //行号  
  
    function  btn_submit_addgoods() {   //确认提交添加商品		 
		 var checkvalid = true;
		       checkvalid = checkvalid && checkEmpty( $( "#goods_type_stock" ) , "商品分类" ) ;
         ...
         if (checkvalid) {	
		       var goods_type = trim( ( $( "#goods_type_stock" ).find("option:selected").text() ).replace("├", "") ) ;
			   var str='<tr id="option'+rowCount+'" >';
					...
					str=str+'<td  class="yt_nodisplay"  >'+$( "#goods_type_stock" ).val()+'</td>';
					str=str+'<td>'+$( "#goods_unit" ).val()+'</td>';
					str=str+'<td  class="yt_text_right">'+$( "#goods_quantity" ).val()+'</td>';
					str=str+'<td  class="yt_nodisplay">'+$( "#goods_unitprice" ).val()+'</td>';			
					str=str+'<td  class="yt_nodisplay">'+$( "#goods_money" ).val()+'</td>';
			   ...
			   var str1='<tr id="option_bak'+rowCount+'" >';
					...
					str1=str1+'<td  class="yt_nodisplay"  >'+$( "#goods_type_stock" ).val()+'</td>';
					str1=str1+'<td>'+$( "#goods_unit" ).val()+'</td>';
					str1=str1+'<td  class="yt_text_right">'+$( "#goods_quantity" ).val()+'</td>';
					str1=str1+'<td  class="yt_nodisplay">'+$( "#goods_unitprice" ).val()+'</td>';			
					str1=str1+'<td  class="yt_nodisplay">'+$( "#goods_money" ).val()+'</td>';

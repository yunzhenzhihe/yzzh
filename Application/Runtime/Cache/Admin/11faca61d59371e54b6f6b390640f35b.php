...
<div class="modal-content modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModal1Label"
   ...
   <script>
	   ...
	   YTaction='/yzzh/ytsoft.php?s=/Admin/Virtuality/index';  
   </script>   
...
<script>
    $('.goodscate').each(function () {
        $(this).click(function () {
            ...
            $.post('/yzzh/ytsoft.php?s=/Admin/Virtuality/goodscatelist', {gid: gid}, function (data) {
                if (data) {
                    ...
                    $('.ssi-upload1').ssi_uploader({
                        url: '/yzzh/ytsoft.php?s=/Admin/Virtuality/upload',
                        dropZone: false,
                        maxFileSize: 100,
                        allowed: ['obj', 'mtl']
                    });
                    ...
                    $('.btn-delete').each(function () {
                        $(this).click(function () {
                            ...
                            if(bol){
                             $.ajax({
                                 url: "/yzzh/ytsoft.php?s=/Admin/Virtuality/delete",
                    ...
                    $('.btn-warning').each(function () {
                        $(this).click(function () {
                            ...
                            $.ajax({
                                url: '/yzzh/ytsoft.php?s=/Admin/Virtuality/mtlinfo',
                                data: {cate_id: cate_id},
                                type: "post",
                                cache: false,
                                async: false,
                                        ...
                                        $(this).change(function () {
                                            ...
                                            if (bol) {
                                                $.ajax({
                                                    ...
                                                    type: "post",
                                                    url: "/yzzh/ytsoft.php?s=/Admin/Virtuality/related",
                                                    cache: false,
                                                    async: false,
                                                    success: function (mes) {
//                                                        alert(mes);
                    ...
                    $('.upimgbtn').each(function () {
                        $(this).click(function () {
                            ...
                            $.post('/yzzh/ytsoft.php?s=/Admin/Virtuality/modelmap', {cate_id: cate_id, cate: cate}, function (mes) {
                                if (mes) {
                                    var list1 = "<tbody>";
                                    var s = 0;
...
<script>
 ...
 <div>
	...
	<input id="url_url"  value="/yzzh/ytsoft.php?s=/Admin/Virtuality"  type="hidden" />

...
<body class="login ">
	...
	<div class="content yt_input-large500 ">
		<!-- BEGIN LOGIN FORM -->
		<form class="login-form" action="JavaScript:YTlogin_dologin('/yzzh/ytsoft.php?s=/Admin/User/dologin');" method="post">
			...
			<div class="form-group">
				...
				<div class="input-icon input-group">
				    ...
				    <img src="/yzzh/ytsoft.php?s=/Admin/User/verify" width="78" height="33" onclick="JavaScript:YTlogin_resetVerifyCode();" class="checkcode"  title="点击刷新验证码" id="verifyImage"/>
			...
			<div class="forget-password">
				...
				<!--    <a href="javascript:;"  id="forget-password">忘了密码\修改密码？</a>	 -->
					 ...
					 <?php if($login_flag == null) : ?>	
					       <a  href="/yzzh/ytsoft.php?s=/Admin/User/forget"  >忘了密码\修改密码？</a> 
					       <a class="yt_float_right" href="/yzzh/ytsoft.php?s=/Admin/User/register"  >新公司注册</a> 
					  <?php endif ?>						
				</p>
			</div>
			<?php if($login_flag == null) : ?>				
	...
	<script>
		...
		YTurl = '/yzzh/ytsoft.php?s=/Admin/User';
...
<!-- END BODY -->
 ...
 <div>
	...
	<input id="url_url"  value="/yzzh/ytsoft.php?s=/Admin/User"  type="hidden" />

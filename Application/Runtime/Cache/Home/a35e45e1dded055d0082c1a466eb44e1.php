...
<body class="page-header-fixed page-full-width"> 
   ...
   <div class="container">
      ...
      <div class="page-container">	  	  
		 ...
		 <h3 class="yt_margintop5 yt_marginbottom15 ">公司信息</h3>		 
		 <table class="table  table-bordered " >  
			<tbody>	
					<TR >
						<TD width="30%" align="right"  style="vertical-align:middle;"  >公司名称：</TD>						
						<TD width="70%" ><?php echo ($user["company_name"]); ?></TD>	
					 </TR>	
					<TR >
						<TD width="30%" align="right"  style="vertical-align:middle;"  >公司地址：</TD>						
						<TD width="70%" ><?php echo ($user["s_province"]); ?>&nbsp;&nbsp;<?php echo ($user["s_city"]); ?>&nbsp;&nbsp;<?php echo ($user["s_county"]); ?>&nbsp;&nbsp;<?php echo ($user["company_address"]); ?></TD>	
					 </TR>							 
					 <TR >
						<TD width="30%" align="right"  style="vertical-align:middle;"  >注册时间：</TD>						
						<TD width="70%" ><?php echo ($user["creat_date"]); ?>	</TD>	
					 </TR>	
					 <TR >
						<TD width="30%" align="right"  style="vertical-align:middle;"  >公司联系人姓名：</TD>						
						<TD width="70%" ><?php echo ($user["name"]); ?>	</TD>	
					 </TR>		
					 <TR >
						<TD width="30%" align="right"  style="vertical-align:middle;"  >公司联系人电话：</TD>						
						<TD width="70%" ><?php echo ($user["phone"]); ?>	</TD>	
					 </TR>		
					 <TR >
						<TD width="30%" align="right"  style="vertical-align:middle;"  >公司联系人邮件：</TD>						
						<TD width="70%" ><?php echo ($user["mail"]); ?>	</TD>	
					 </TR>							 
			 </tbody>		
		 </table>	
   ...
   <script>
	   ...
	   YTaction='/yzzh/ytsoft.php?s=/Home/Setcompany/company_info';  
   </script>   

							  ...
							  <?php else : ?>
								<?php if(is_array($recordlist)): $k = 0; $__LIST__ = $recordlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><TR >
									...
									<TD>
										   ...
										   <button  class="btn dark btn-xs   yt_marginleft5 yz_down"  onClick=" down_record('<?php echo ($vo['id']); ?>','<?php echo ($vo['sort']); ?>')  "  >
				  ...
				  <div class="modal-body " >
						<form class="form-horizontal" role="form">
						  ...
						  <div class="form-group" id="value_disp"  >
							   ...
							   <div class="col-md-8">										   
									 <input type="text" id="value" class="form-control select2" required data-placeholder="请输入..." name="inputdatabox" >
							   </div>
							</div>							  

...
<body class="page-header-fixed page-full-width"> 
                              ...
                              <div class="tab-content">
								...
								<div class="yt_form_group_left_70 ">		  
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-9">
                                          <input type="text" class="form-control  required " name="phone_number" value="<?php echo ($callnumber); ?>" >
                                            <span class="help-block">多个电话连输，用逗号分隔。区号和号码之间不要加分隔符，比如是010123456，不能是010-123456 																	
											</span>
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                       <label class="control-label col-md-3">电子邮件<span class="required" ></span></label>
                                       <div class="col-md-9">
								...
								<div class="col-md-6  ">
												...
												<div>
													<input id="warranty_interval_days"  value="<?php echo (session('warranty_interval_days')); ?>"  type="hidden" /> <!--质保截至默认时间长度  天 --> 
   ...
   <script>
	   ...
	   YTaction='/yzzh/ytsoft.php?s=/Home/Customer/customer_add';  
   </script>   
...
<script src="/yzzh/Public/Minify/index.php?g=web_mapjs" type="text/javascript"></script>  
   ...
   <script>
	...
	$('#form_wizard_1 .button-submit').click(function () { 
	    var url='/yzzh/ytsoft.php?s=/Home/Customer/'+'ajaxinsert1';

            ...
            <div class="card">
                ...
                <li class="btn-group yt_float_left">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                        <strong>
                            <?php if(is_array($goods_name)): foreach($goods_name as $key=>$name): ?><li><a href="javascript:void(0);" class="goodscate" gid="<?php echo ($name["id"]); ?>"><?php echo ($name["name"]); ?></a></li><?php endforeach; endif; ?>
                        </strong>
                    </ul>
                </li>
...
<div class="modal-content modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModal1Label" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h5 class="modal-title" id="myModalLabel">属性关联</h5>
    </div>
    <div class="modal-body" id="selectimg">
        <table class="table table-hover table-condensed table-striped table-bordered" id="table2">
            <thead>
            <tr>
                <th>序号</th>
                <th>属性</th>
                        ...
                        $(this).click(function () {
                            ...
                            $.post('/yzzh/ytsoft.php?s=/Home/Virtuality/modelmap',{cate_id:cate_id,cate:cate},function (mes) {
                                    if(mes){
                                        ...
                                        $('.list1').empty();
                                        $('#table1').append(list1);
                                        $('.ssi-upload').ssi_uploader({url:'/yzzh/ytsoft.php?s=/Home/Virtuality/upload',maxFileSize:60,allowed:['jpg', 'gif', 'png', 'jpeg']});
                                    }else{
                                        alert('请先在该商品下添加字段和值！');
                                    }
                            });

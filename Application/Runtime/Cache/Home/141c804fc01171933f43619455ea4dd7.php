            ...
            <table class="table   table-hover table-bordered " id="yt_table">
                ...
                <?php if(is_array($recordlist)): $k = 0; $__LIST__ = $recordlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><TR>
                        ...
                        <TD>
                            ...
                            <a id="yt_btn_del" class="btn green btn-xs  yt_marginleft5" href="<?php echo U('Setdefaultfields/defaultfields_list', array( 'id' => $vo['id'] ));?>">
                ...
                <!--<div class="col-md-12 yt_margintop15 ">-->
									 ...
									 <!--<span class="col-md-4 " >-->
										   <!--<select  class="input-sm   " id="NumberOfRows" onchange="YTnumberofrows(this.options[this.selectedIndex].value)" >-->
												<!--<?php if(is_array($selectrowslist)): $i = 0; $__LIST__ = $selectrowslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
													 <!--<option  value="<?php echo ($vo); ?>" >每页显示&nbsp;<?php echo ($vo); ?>&nbsp;条</option>-->
...
<div id="yt_dialog_form" class="modal fade" tabindex="-1" aria-hidden="true" data-width="550" >
    ...
    <div class="modal-body " >
        <form class="form-horizontal" role="form">
            <div class="form-group">
                <label for="cat_name" class="col-sm-3 control-label">商品分类<span class="required" >*</span></label>
                <div class="col-sm-8 " >
                    <input type="text" class="form-control" id="cat_name" name="inputdatabox" >
                </div>
            </div>
            <div class="form-group">
                <label for="parent_id" class="col-sm-3 control-label">上级分类<span class="required" >*</span></label>
                <div class="col-sm-8">
                    <select name="selectdatabox" require="1"  id="parent_id"  class="col-md-14 form-control" >
    ...
    <div class="modal-footer">
        <button type="button" data-dismiss="modal" class="btn default" id="yt_dialog_btn_cancel">取消<tton>
            <button type="button" class="btn green" id="yt_dialog_btn_ok">确认<tton>
    </div>
</div>
<!-- END DIALOG_FORM  -->
...
<!--   END PAGE -->
   ...
   <script>
	   ...
	   YTaction='/yzzh/ytsoft.php?s=/Home/Setgoodscate/index';  
   </script>   
...
<script>
    $('#cate_add').click(function () {
        ...
        var gid = $('#gid').val();
        var cate = $('#cate').val();
        $.post('/yzzh/ytsoft.php?s=/Home/Setgoodscate/add',{id:id,gid:gid,cate:cate},function (json) {
            if(json.status == 1){
                alert("添加成功！");
...
<script type="text/javascript">
    function dialogcheckdata() {
        var checkvalid = true;
        checkvalid = checkvalid && checkLength( $( "#cate" ), "分类名称", StringLength001, StringLength100 );
        return checkvalid;
    };

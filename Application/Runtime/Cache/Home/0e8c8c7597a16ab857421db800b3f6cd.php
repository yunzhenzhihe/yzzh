            ...
            <table class="table   table-hover table-bordered " id="yt_table">
                ...
                <?php if(is_array($recordlist)): $k = 0; $__LIST__ = $recordlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><TR >
                        ...
                        <TD>
                            ...
                            <a id="yt_btn_del" class="btn red btn-xs  yt_marginleft5  "  href="<?php echo U('Setgoods/delete', array( 'id' => $vo['id'] ));?>"  >
                                删除 <i class="icon-remove"></i>
                            </a>
                            <a id="yt_btn_add" class="btn yellow btn-xs  yt_marginleft5" href="<?php echo U('Setgoodscate/cate_list', array( 'id' => $vo['id'] ));?>">
...
<!--   END PAGE -->
   ...
   <script>
	   ...
	   YTaction='/yzzh/ytsoft.php?s=/Home/Setgoods/goods_list';  
   </script>   
...
<script type="text/javascript">
 ...
 <div>
	...
	<input id="url_url"  value="/yzzh/ytsoft.php?s=/Home/Setgoods"  type="hidden" />

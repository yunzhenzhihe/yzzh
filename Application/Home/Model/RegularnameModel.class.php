...
class RegularnameModel extends Model {
	// 自动验证设置
	protected $_validate	 =	 array(	
		array('name','checkStringLength_regularname','提醒项目不能为空，并且长度必须在 1-100 之间',1,'callback'), 
		array('name','checkUnique_regularname','提醒项目重复',1,'callback'),  		
	);
	// 自动完成
   ...
   protected function checkUnique_regularname(){   //判断唯一性	
       return checkVarUnique('regularname','name')  ;    
   } 

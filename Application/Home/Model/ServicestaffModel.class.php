...
class ServicestaffModel extends Model {
	...
	protected $_validate	 =	 array(	
		array('name','checkStringLength_unit','售后人员不能为空，并且长度必须在 1-100 之间',1,'callback'), 
		array('name','checkUnique_name','售后人员名称重复',1,'callback'),  		
	);
	// 自动完成
   protected $_auto = array ( 
		...
		array('guid','getGuid',1,'callback'),  // 新增的时候把guid字段写入一个随机数 唯一识别码
    );
   ...
   protected function checkUnique_name(){   //判断唯一性	
       return checkVarUnique('servicestaff','name')  ;    
   } 

...
class ComplaintypeModel extends Model {
	// 自动验证设置
	protected $_validate	 =	 array(	
		array('name','checkStringLength_name','投诉类型不能为空，并且长度必须在 1-100 之间',1,'callback'), 
		array('name','checkUnique_name','投诉类型重复',1,'callback'),  		
	);
	// 自动完成
   ...
   protected function checkUnique_name(){   //判断唯一性	
       return checkVarUnique('complaintype','name')  ;    
   } 

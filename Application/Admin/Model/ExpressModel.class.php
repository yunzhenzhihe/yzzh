...
class ExpressModel extends Model {
	...
	protected $_validate	 =	 array(	
		array('name','checkStringLength_unit','快递公司名称不能为空，并且长度必须在 1-100 之间',1,'callback'), 
		array('name','checkUnique_unit','快递公司名称重复',1,'callback'),  		
	);
	// 自动完成
   ...
   protected function checkUnique_unit(){   //判断唯一性	
       return checkVarUnique('express','name')  ;    
   } 

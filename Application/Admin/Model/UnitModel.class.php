...
class UnitModel extends Model {
	...
	protected $_validate	 =	 array(	
		array('name','checkStringLength_unit','单位不能为空，并且长度必须在 1-20 之间',1,'callback'), 
		array('name','checkUnique_unit','单位重复',1,'callback'),  		
	);
	// 自动完成
   ...
   protected function checkUnique_unit(){   //判断唯一性	
       return checkVarUnique('unit','name')  ;    
   } 
     
   protected function checkStringLength_unit(){   //判断字符串的长度是否在一个范围内  
	   return checkStringLength('name','1','20');    
   }  

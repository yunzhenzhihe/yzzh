...
class Customrecordfields3Model extends Model {
	// 自动验证设置
	protected $_validate	 =	 array(	
		array('name','checkStringLength_unit','字段不能为空，并且长度必须在 1-100 之间',1,'callback'), 
		array('name','checkUnique_unit','字段重复',1,'callback'),  		
	);
	// 自动完成
   ...
   protected function checkUnique_unit(){   //判断唯一性	
       return checkVarUnique('Customrecordfields3','name')  ;    
   } 
